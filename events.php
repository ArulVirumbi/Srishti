...
<div class="container-fluid">
  <div class="category-bar">
            <nav>
                ...
                <a href="#category-1">TECHNICAL</a>
                <a href="#category-2">NON-TECHNICAL</a>
                <a href="#category-3">FLAGSHIP</a>
            </nav>
        </div>
                ...
                <div class="categories container">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center justify-content-center">
                            <div class="nos no-1 card card1" id="div-1" style="width: 300px;">
                                <h3>Event 1</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center justify-content-center">
                            <div class="nos no-2 card card1" id="div-2"  style="width: 300px;">
                                <h3>Event 2</h3>
                                <p class="small">What you see there? There... Behind you, Right, Left and Infront of you. What do you see? Do you get it?.</p>
                                <div class="go-corner">
                                    <img class="event-logo" src="assets/img/events/18.png" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center justify-content-center">
                            <div class="nos no-3 card card1" id="div-3" style="width: 300px;">
                                <h3>Event 3</h3>
                                <p class="small">What you see there? There... Behind you, Right, Left and Infront of you. What do you see? Do you get it?.</p>
                                <div class="go-corner">
                                    <img class="event-logo" src="assets/img/events/18.png" alt="">
