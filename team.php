    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card p-3 py-4 mt-5 mb-5">
                <div class="text-center"> <div class="imgbo"><img src="https://d19m59y37dris4.cloudfront.net/university/1-1-1/img/teacher-1.jpg" width="170" class="rounded-circle"></div>
                    ...
                    <div class="social-buttons mt-5">  <button class="neo-button"><i class="fa fa-linkedin fa-1x"></i></button> <button class="neo-button"><i class="fa fa-envelope"></i> </button>  </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
